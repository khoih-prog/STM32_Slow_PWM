...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/STM32_Slow_PWM_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/STM32_Slow_PWM_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/STM32_Slow_PWM_GitHub$ bash utils/restyle.sh
```
